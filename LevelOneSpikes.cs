...
public class LevelOneSpikes : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            amazingCamera.transform.position = new Vector3(16.3f, 0f, -10f);
            isOne = true;
            isTwo = false;
            isThree = false;
        }
        ...
        {
            amazingCamera.transform.position = new Vector3(38.07f, 0f, -10f);
            isOne = false;
            isTwo = true;
            isThree = false;
        }
        ...
        {
            amazingCamera.transform.position = new Vector3(52.87f, 0f, -10f);
            isOne = false;
            isTwo = false;
            isThree = true;
        }
